...
int main(int argc, char *argv[]) {
    ...
    out = fopen("keymap.cc", "w");
    if (out == NULL) {
	fprintf(stderr, "keymap2cc: can't open output file \"keymap.cc\"\n");
	return 1;
    }
	...
	" * This file is generated by the keymap2cc program from the keymap.txt file.\n"
