...
static int fcn_cat[] = {
    ...
    CMD_FIND,     CMD_MAX,       CMD_MIN,      CMD_NONE,       CMD_NONE,    CMD_NONE
};
...
static int ext_time_cat[] = {
    ...
    CMD_YMD,       CMD_NONE,  CMD_NONE,    CMD_NONE,  CMD_NONE,  CMD_NONE
};

static int ext_xfcn_cat[] = {
    CMD_ANUM, CMD_RCLFLAG, CMD_STOFLAG, CMD_X_SWAP_F, CMD_NONE, CMD_NONE
};

static int ext_base_cat[] = {
    CMD_BRESET, CMD_BSIGNED, CMD_BWRAP, CMD_WSIZE, CMD_WSIZE_T, CMD_NONE
};
...
static int ext_str_cat[] = {
    ...
    CMD_REV,    CMD_SUBSTR,  CMD_S_TO_N, CMD_XASTO,  CMD_NONE,   CMD_NONE
};
...
static int ext_stk_cat[] = {
    ...
    CMD_UNPICK, CMD_NONE,  CMD_NONE, CMD_NONE,  CMD_NONE, CMD_NONE
};
...
static int ext_misc_cat[] = {
    ...
    CMD_FPTEST,  CMD_NONE,    CMD_NONE,   CMD_NONE,  CMD_NONE,  CMD_NONE
};
...
static int ext_misc_cat[] = {
    CMD_A2LINE,  CMD_A2PLINE, CMD_CAPS,   CMD_FMA,    CMD_MIXED, CMD_PCOMPLX,
    CMD_RCOMPLX, CMD_STRACE,  CMD_X2LINE, CMD_FPTEST, CMD_NONE,  CMD_NONE
};
#define MISC_CAT_ROWS 2
#else
static int ext_misc_cat[] = {
    CMD_A2LINE,  CMD_A2PLINE, CMD_CAPS,   CMD_FMA,  CMD_MIXED, CMD_PCOMPLX,
    CMD_RCOMPLX, CMD_STRACE,  CMD_X2LINE, CMD_NONE, CMD_NONE,  CMD_NONE
};
#define MISC_CAT_ROWS 2
#endif
#endif
