...
static int ext_stk_cat[] = {
    ...
    CMD_L4STK,  CMD_LNSTK, CMD_NSTK, CMD_PICK,  CMD_RDNN, CMD_RUPN,
...
static int ext_misc_cat[] = {
    CMD_FMA,     CMD_GETKEY1, CMD_NOP,  CMD_STRACE, CMD_ACCEL, CMD_LOCAT,
...
#ifdef FREE42_FPTEST
static int ext_misc_cat[] = {
    CMD_FMA, CMD_GETKEY1, CMD_NOP, CMD_STRACE, CMD_FPTEST, CMD_NULL
};
#define MISC_CAT_ROWS 1
#else
static int ext_misc_cat[] = {
    CMD_FMA, CMD_GETKEY1, CMD_NOP, CMD_STRACE, CMD_NULL, CMD_NULL
};
#define MISC_CAT_ROWS 1
#endif
#endif
