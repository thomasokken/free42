...
static int ext_fcn_cat[] = {
    ...
    CMD_YMD,
    CMD_BRESET, CMD_BSIGNED, CMD_BWRAP, CMD_FMA,
    CMD_FUNC0, CMD_FUNC1, CMD_FUNC2, CMD_RTNYES, CMD_RTNNO,
    CMD_RTNERR, CMD_GETKEY1, CMD_LASTO, CMD_LSTO, CMD_NOP,
    CMD_SST_UP, CMD_SST_RT, CMD_WSIZE, CMD_WSIZE_T,
